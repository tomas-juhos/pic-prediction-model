...
class LightGBM:
    ...
    def train(self):
        # todo feed dataset correctly using as_dataframe function and data in the init
        ...
        self.model_gbm = lightgbm.train(
            self.params, train_data, early_stopping_rounds=0
        )

    def predict_valid(self):
        self.y_train_pred = self.model_gbm.predict(
            self.y_train.reshape(self.x_valid.shape[0], self.y_train.shape[1])
        )
